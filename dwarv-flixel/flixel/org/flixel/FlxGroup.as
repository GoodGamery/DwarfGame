package org.flixel
{
	...
	public class FlxGroup extends FlxBasic
	{
		...
		public var bGroupPaused:Boolean = false;
		public function GroupPause(pause:Boolean):void
		{
			bGroupPaused = pause;
		}
		...
		override public function update():void
		{
			...
			while(i < length)
			{
				...
				else
				{
					...
					{
						if (!bGroupPaused || !basic.pausable)
						{
							basic.preUpdate();
							basic.update();
							basic.postUpdate();
		...
		public function destroymembers():void
		{
			...
			while(i < length)
			{
				basic = members[0] as FlxBasic;
				if (basic != null)
				{
					basic.destroy();
					this.remove(basic, true);
				}
				else
				{
					members.splice(0, 1);
