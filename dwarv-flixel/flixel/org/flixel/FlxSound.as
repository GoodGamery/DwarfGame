package org.flixel
{
	...
	public class FlxSound extends FlxBasic
	{
		...
		public var bUseCallback:Boolean = false;
		public function play(ForceRestart:Boolean=false, position:Number=0, usecallback:Boolean = false):void
		{
			bUseCallback = usecallback;
		...
		protected function looped(event:Event=null):void
		{
			...
			if (bUseCallback)
				...
				play(false, Content.nDefaultMusicSkip);
		}
