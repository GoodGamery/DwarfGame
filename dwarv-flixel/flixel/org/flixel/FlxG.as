package org.flixel
{
	...
	public class FlxG
	{
		...
		static public function playMusic(Music:Class,Volume:Number=1.0, position:Number = 0):void
		{
			if(music == null)
				music = new FlxSound();
		 ...
		 */
		static public function loadSound(EmbeddedSound:Class=null,Volume:Number=1.0,Looped:Boolean=false,AutoDestroy:Boolean=false,AutoPlay:Boolean=false,URL:String=null,skip:Number=0):FlxSound
		{
		 ...
		 * @return	A <code>FlxSound</code> object.
		 */
		static public function play(EmbeddedSound:Class,Volume:Number=1.0,Looped:Boolean=false,AutoDestroy:Boolean=true,skip:Number=0):FlxSound
		{
			return FlxG.loadSound(EmbeddedSound,Volume,Looped,AutoDestroy,true,null,skip);
		}
		...
		static public function Pause(pause:Boolean=true):void
		{
			if(pause)
				_game.stage.frameRate = 10;
			else
				_game.stage.frameRate = _game._flashFramerate;
