package org.flixel
{
	...
	public class FlxRect
	{
		...
		public function offsetOverlaps(xoff:int, yoff:int, Rect:FlxRect, txoff:int, tyoff:int):Boolean
		{
			return (Rect.x + txoff + Rect.width > x + xoff) && 
				(Rect.x + txoff < x + width + xoff) && 
				(Rect.y + tyoff + Rect.height > y + yoff) && 
				(Rect.y + tyoff < y + height + yoff);
		}
	}
}
